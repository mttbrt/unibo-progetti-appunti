...
// Da chiamare quando si devono sommare i contributi di Phong equivale nelle slide alla funzione "phong(q, n, r)" ovvero calcola il contrubuto locale
// Se ci sono 5 luci in scena questo metodo viene chiamato per ognuna sommando i risultati
Vec3f
Material::Shade (const Ray & ray, const Hit & hit, const Vec3f & dirToLight, const Vec3f & lightColor, ArgParser * args) const
{

  Vec3f point = ray.pointAtParameter (hit.getT ()); // hit è il punto intersecato, trasformo in punto con coordinate
