...
public class ExtensionParser extends Parser {
	...
	public static final String[] tokenNames = {
		...
		"'='", "'}'", "'if'", "'<='", "'delete'", "'int'", "'print'", "'('", "'*'", 
		"','", "'var'", "'>='", "'<'", "'=='", "'val'", "'>'", "'bool'", "'OR'", 
		"'else'", "')'", "'then'", "'+'", "'-'", "ID", "NUMBER", "TF", "WS", "LINECOMMENTS", 
		"BLOCKCOMMENTS", "ERR"
	};
	public static final int
	...
	public static class BlockContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitBlock(this);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SimpleStatementContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitSimpleStatement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class VariableDeclarationContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitVariableDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionDeclarationContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitFunctionDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FormalParametersContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitFormalParameters(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FormalParameterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitFormalParameter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TypeDeclarationContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitTypeDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AssignmentContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitAssignment(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionCallContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitFunctionCall(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ActualParametersContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitActualParameters(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ActualParameterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitActualParameter(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeletionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitDeletion(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class PrintContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitPrint(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExpContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitExp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NegArithmeticExpContext extends ArithmExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitNegArithmeticExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValArithmeticExpContext extends ArithmExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitValArithmeticExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BinArithmeticExpContext extends ArithmExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitBinArithmeticExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BaseArithmeticExpContext extends ArithmExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitBaseArithmeticExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class VarArithmeticExpContext extends ArithmExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitVarArithmeticExp(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BoolComparisonExpContext extends BoolExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitBoolComparisonExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NegBoolExpContext extends BoolExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitNegBoolExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ValBoolExpContext extends BoolExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExtensionVisitor ) return ((ExtensionVisitor<? extends T>)visitor).visitValBoolExp(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class BaseBoolExpContext extends BoolExpContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof 